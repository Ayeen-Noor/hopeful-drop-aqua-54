              ...
              <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                <div className="relative group">
                  ...
                  <div className="relative bg-background rounded-2xl p-6 shadow-strong">
                    <div className="aspect-[4/3] bg-gradient-to-br from-muted to-muted/50 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                      <div className={`w-24 h-24 bg-gradient-to-br ${app.gradient} rounded-full flex items-center justify-center`}>
